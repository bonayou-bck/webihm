<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button type="button" id="livein-add" class="btn btn-primary btn-sm btn-label waves-effect waves-light"><i
    ...
    <div class="card-body pb-0">
        <form id="form-home-slide" action="{{ route('slide.upload') }}/1" method="POST">
            @csrf
            <div class="team-list grid-view-filter row" id="form-home-slide-item-wrapper">

                @if ($slideData)

                    @isset($slideData['live-in'])
                        @foreach ($slideData['live-in']['live-in'] as $key => $data)
                            <div class="col">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li>
                                                                <button type="button" class="dropdown-item edit-list" 
                                                                    ...
                                                                    <i
                                                                        class="ri-pencil-line me-2 align-bottom text-muted"></i>
                                                                    Edit
                                                                </button>
                                                            </li>
                                                            <li>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="modal-addedit-form" action="{{ route('video.upload', 1) }}" 
										method="POST" enctype="multipart/form-data"
										data-url-create="{{ route('video.upload', 1) }}"
										data-url-update="{{ route('video.upload.update', [1, 0]) }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
														...
														<input type="file" class="filepond" 
														 name="photo" data-allow-reorder="true" 
                        ...
                        <div class="col-6">
														...
														<input type="file" class="filepond" 
															name="video" data-allow-reorder="true" 
															data-max-file-size="2MB" data-max-files="1">
														{{-- <button type="button" onClick="openModal()"
                ...
                <div class="modal-footer p-0">
                    ...
                    <button type="submit" form="modal-addedit-form" class="btn btn-primary btn-sm">
...
@push('livein-script')
    <script>
        const liveInAddBtn = document.getElementById('livein-add');
				const modalEl = document.querySelector('#addEditModal');
				const modal = new bootstrap.Modal(modalEl, {
					keyboard: false
				});
				modalEl.addEventListener('hidden.bs.modal', event => {
					const createUrl = modalEl.querySelector('form').dataset.urlCreate;
					modalEl.querySelector('form').action = createUrl;
					modalEl.querySelector('form input[name=name]').value = "";
					modalEl.querySelector('form input[name=description]').value = "";

					clearFilepond();
				});

        liveInAddBtn.addEventListener('click', function() {
						modal.show();
        ...
        function onEdit(e) {
						...
						let updateUrl = modalEl.querySelector('form').dataset.urlUpdate;
						updateUrl = updateUrl.replace('/0', `/${raw.id}`);
						modalEl.querySelector('form').action = updateUrl;

						console.log(raw);
						console.log(updateUrl);

						// assign value
						modalEl.querySelector('form input[name=name]').value = raw.name;
						modalEl.querySelector('form input[name=description]').value = raw.description;
