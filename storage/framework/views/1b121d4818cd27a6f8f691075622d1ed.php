    ...
    <div class="main-header-logo">
        <div class="logo-header" data-background-color="dark">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo">
                <img src="<?php echo e(asset('assets/admin/img/kaiadmin/logo_light.png')); ?>" alt="navbar brand" class="navbar-brand"
                    height="20" />
            </a>
            ...
            <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                <li class="nav-item topbar-user dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                        aria-expanded="false">
                        <div class="avatar-sm">
                            <img src="<?php echo e(Auth::user() && Auth::user()->avatar
                        ...
                        <span class="profile-username" style="cursor:pointer;">
                            ...
                            <span class="fw-bold"><?php echo e(Auth::user() ? Auth::user()->name : 'Guest'); ?></span>
                        </span>
                    </a>
                    ...
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <li>
                            <div class="dropdown-user-scroll scrollbar-outer">
                                <div class="user-box">
                                    ...
                                    <div class="u-text">
                                        <h4><?php echo e(Auth::user() ? Auth::user()->name : 'Guest'); ?></h4>
                                        <p class="text-muted"><?php echo e(Auth::user() ? Auth::user()->email : ''); ?></p>
                        ...
                        <li>
                            ...
                            <form id="logout-form-admin" action="<?php echo e(route('logout')); ?>" method="POST"
                                style="display:none;">
                                <?php echo csrf_field(); ?>
                            </form>
                            
                            <form id="logout-form-modal" action="<?php echo e(route('logout')); ?>" method="POST"
                                style="display:none;">
                                <?php echo csrf_field(); ?>
                            </form>
                        </li>
        ...
        <div class="modal-content border-0 shadow-lg overflow-hidden">
            ...
            <div class="modal-body text-center bg-white logout-card">
                <div class="d-flex flex-column align-items-center">
                    <img src="<?php echo e(Auth::user() && Auth::user()->avatar ? asset('images/' . Auth::user()->avatar) : asset('assets/admin/img/profile.jpg')); ?>"
                        alt="avatar" class="logout-avatar mb-3">
                    <h5 class="mb-1"><?php echo e(Auth::user() ? Auth::user()->name : 'Guest'); ?></h5>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/bona/Downloads/webihm1/resources/views/partials/navbar.blade.php ENDPATH**/ ?>