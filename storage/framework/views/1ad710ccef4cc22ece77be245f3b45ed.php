...
<?php $__env->startSection('scripts', 'Keberlanjutan'); ?>
<?php $__env->startSection('content'); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php echo e($row->keberlanjutan_img_count ?? ($row->Keberlanjutan_img_count ?? 0)); ?></td>
    ...
    <div class="modal fade" id="modalCreate" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <form class="modal-content" action="<?php echo e(url('admin/keberlanjutan-create')); ?>" method="POST"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.addEventListener('click', async function(ev) {
                    ...
                    try {
                        const res = await fetch(`<?php echo e(url('admin/keberlanjutan')); ?>/${id}`);
...
form.action = `<?php echo e(url('admin/keberlanjutan')); ?>/${id}`;
            ...
            document.addEventListener('click', function(ev) {
                ...
                form.action = `<?php echo e(url('admin/keberlanjutan')); ?>/${id}`; // /admin/keberlanjutan/{id}
                form.submit();
            });
        </script>
    <?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bona/Downloads/webihm1/resources/views/admin/keberlanjutan.blade.php ENDPATH**/ ?>