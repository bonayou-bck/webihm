...
<script src="<?php echo e(asset('assets/js/core/popper.min.js')); ?>" data-no-sourcemap></script>
<script src="<?php echo e(asset('assets/js/core/bootstrap.min.js')); ?>" data-no-sourcemap></script>
