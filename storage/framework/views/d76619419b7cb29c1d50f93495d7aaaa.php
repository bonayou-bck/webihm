      ...
      <div class="row mb-4">
        <div class="col-12">
          <figure class="hero-image">
            <a href="<?php echo e(asset('assets/img/keberlanjutan/lnd.png')); ?>"
               class="glightbox"
               data-gallery="s1"
               data-title="Pengelolaan Lahan"
               data-description="Konservasi area bernilai ekologi tinggi & perencanaan lanskap berkelanjutan.">
              <img src="<?php echo e(asset('assets/img/keberlanjutan/lnd.png')); ?>" alt="Pengelolaan Lahan" loading="lazy" decoding="async">
            </a>
          </figure>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="auto-scroll" data-speed="0.35" id="scroll-s1">
            <div class="auto-track">
              ...
              <a class="tile glightbox" href="<?php echo e(asset('assets/img/keberlanjutan/nursery.png')); ?>" data-gallery="s1" data-title="Nursery & Persemaian" data-description="Produksi bibit untuk rehabilitasi & reforestasi.">
                <img src="<?php echo e(asset('assets/img/keberlanjutan/nursery.png')); ?>" alt="Nursery & Persemaian" loading="lazy">
                <div class="cap"><h3>Nursery & Persemaian</h3></div>
              </a>
              <a class="tile glightbox" href="<?php echo e(asset('assets/img/keberlanjutan/ehs.png')); ?>" data-gallery="s1" data-title="EHS" data-description="Keselamatan kerja, kesehatan, dan pengelolaan dampak lingkungan.">
                <img src="<?php echo e(asset('assets/img/keberlanjutan/ehs.png')); ?>" alt="EHS" loading="lazy">
                <div class="cap"><h3>EHS</h3></div>
              </a>
              <a class="tile glightbox" href="<?php echo e(asset('assets/img/keberlanjutan/qa.png')); ?>" data-gallery="s1" data-title="Quality Assurance" data-description="Kontrol mutu & audit internal untuk praktik berkelanjutan.">
                <img src="<?php echo e(asset('assets/img/keberlanjutan/qa.png')); ?>" alt="Quality Assurance" loading="lazy">
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="row mb-4">
        <div class="col-12">
          <figure class="hero-image">
            <a href="<?php echo e(asset('assets/img/keberlanjutan/ehs.png')); ?>"
               class="glightbox"
               data-gallery="s2"
               data-title="EHS (Environment, Health & Safety)"
               data-description="Kerangka EHS memastikan implementasi berjalan aman dan patuh.">
              <img src="<?php echo e(asset('assets/img/keberlanjutan/ehs.png')); ?>" alt="EHS (Environment, Health & Safety)" loading="lazy" decoding="async">
            </a>
          </figure>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="auto-scroll" data-speed="0.35" data-direction="reverse" id="scroll-s2">
            <div class="auto-track">
              ...
              <a class="tile glightbox" href="<?php echo e(asset('assets/img/keberlanjutan/qa.png')); ?>" data-gallery="s2" data-title="Quality Assurance" data-description="Audit & kontrol mutu sebagai fondasi tata kelola.">
                <img src="<?php echo e(asset('assets/img/keberlanjutan/qa.png')); ?>" alt="Quality Assurance" loading="lazy">
                <div class="cap"><h3>Quality Assurance</h3></div>
              </a>
              <a class="tile glightbox" href="<?php echo e(asset('assets/img/keberlanjutan/pesawat.png')); ?>" data-gallery="s2" data-title="Efisiensi Logistik" data-description="Optimasi rute & moda untuk menekan emisi dan biaya.">
                <img src="<?php echo e(asset('assets/img/keberlanjutan/pesawat.png')); ?>" alt="Efisiensi Logistik" loading="lazy">
                <div class="cap"><h3>Efisiensi Logistik</h3></div>
              </a>
              <a class="tile glightbox" href="<?php echo e(asset('assets/img/keberlanjutan/jen.png')); ?>" data-gallery="s2" data-title="Pemberdayaan Komunitas" data-description="Keterlibatan & edukasi masyarakat sekitar operasional.">
                <img src="<?php echo e(asset('assets/img/keberlanjutan/jen.png')); ?>" alt="Pemberdayaan Komunitas" loading="lazy">
