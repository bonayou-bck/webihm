...
<?php $__env->startSection('content'); ?>
  <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
      <a href="<?php echo e(route('admin.berita')); ?>" class="btn btn-label-light btn-round me-2">
      ...
      <div class="col-lg-4">
          ...
          <div class="card-body">
            ...
            <div class="mb-0">
              ...
              <div class="d-flex align-items-center gap-3">
                <img src="<?php echo e(asset('assets/admin/img/profile.jpg')); ?>" class="thumb-cover" id="previewCover" alt="preview">
        ...
        <div class="card card-round">
          <div class="card-body d-grid gap-2">
            ...
            <a href="<?php echo e(route('admin.berita')); ?>" class="btn btn-secondary btn-round">
              Batal
            </a>
          </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bona/Downloads/webihm1/resources/views/admin/berita-create.blade.php ENDPATH**/ ?>