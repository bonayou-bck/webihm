      ...
      <?php $__env->startSection('title', 'Berita Details - Itci Hutani Manunggal'); ?>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="content">
              ...
              <div class="cta-wrapper">
                <a href="<?php echo e(route('pages.sertifikat')); ?>" class="btn btn-primary">Sertifikat</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="image-wrapper">
              <img src="<?php echo e(asset('assets/img/about/nursery.jpg')); ?>" alt="About Us" class="img-fluid main-image">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="client-logo">
                <img src="<?php echo e(asset('assets/img/clients/aja.png')); ?>" class="img-fluid" alt="">
              </div>
            </div><!-- End Client Item -->

            <div class="swiper-slide">
              <div class="client-logo">
                <img src="<?php echo e(asset('assets/img/clients/ifcc.png')); ?>" class="img-fluid" alt="">
              </div>
            </div><!-- End Client Item -->

            <div class="swiper-slide">
              <div class="client-logo">
                <img src="<?php echo e(asset('assets/img/clients/iso14.png')); ?>" class="img-fluid" alt="">
              </div>
            </div><!-- End Client Item -->

            <div class="swiper-slide">
              <div class="client-logo">
                <img src="<?php echo e(asset('assets/img/clients/iso45.png')); ?>" class="img-fluid" alt="">
              </div>
            </div><!-- End Client Item -->

            <div class="swiper-slide">
              <div class="client-logo">
                <img src="<?php echo e(asset('assets/img/clients/pefc.png')); ?>" class="img-fluid" alt="">
              </div>
            </div><!-- End Client Item -->

            <div class="swiper-slide">
              <div class="client-logo">
                <img src="<?php echo e(asset('assets/img/clients/ti.png')); ?>" class="img-fluid" alt="">
              </div>
            </div><!-- End Client Item -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="services-image">
              <img src="<?php echo e(asset('assets/img/about/nobgJane.png')); ?>" alt="Business Services" class="img-fluid">
          ...
          <div class="row">
            <div class="col-lg-12 d-flex justify-content-center mt-4">
              <ul class="portfolio-filters isotope-filters">
                ...
                <li>
                    <a href="<?php echo e(route('pages.keberlanjutan')); ?>" style="text-decoration:none; color:inherit;">
                        Selengkapnya >>
                    </a>
                </li>
              </ul>
            ...
            <div class="swiper-slide">
              <div class="team-card">
                <div class="team-image">
                  <img src="<?php echo e(asset('assets/img/person/person-f-9.webp')); ?>" class="img-fluid" alt="" loading="lazy">
          ...
          <div class="col-12">
            <div class="container section-title">
              <div class="swiper-navigation">
                  <a href="<?php echo e(route('pages.berita')); ?>"><br>Selengkapnya</a>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="<?php echo e(asset('assets/img/person/person-m-9.webp')); ?>" class="testimonial-img" alt="">
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="<?php echo e(asset('assets/img/person/person-f-5.webp')); ?>" class="testimonial-img" alt="">
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="<?php echo e(asset('assets/img/person/person-f-12.webp')); ?>" class="testimonial-img" alt="">
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="<?php echo e(asset('assets/img/person/person-m-13.webp')); ?>" class="testimonial-img" alt="">
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
              </div>
            </div>
